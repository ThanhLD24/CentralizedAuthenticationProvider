...
import { sampleWithRequiredData } from '../access-token.test-samples';
...
describe('AccessToken Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.accessTokens()[0]).toEqual(expect.objectContaining({ id: 16439 }));
  });

  describe('trackId', () => {
    it('should forward to accessTokenService', () => {
      const entity = { id: 16439 };
      jest.spyOn(service, 'getAccessTokenIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAccessTokenIdentifier).toHaveBeenCalledWith(entity);
